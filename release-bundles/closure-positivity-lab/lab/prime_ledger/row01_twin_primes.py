...
1923). C2 is the product over all odd places p of (1 - 1/(p-1)^2): the twin
pattern {0,2} is admissible at every finite place, and each place contributes a
definite density factor. Existence-and-density of twins IS this all-places
product being positive.
...
def run(s=None, checkpoints=(10_000_000, 25_000_000, None)):
    ...
    return core.row_result(
        ...
        "infinitude <-> pair correlation of zeros (explicit formula); "
        "unconditional frontier: bounded gaps <= 246",

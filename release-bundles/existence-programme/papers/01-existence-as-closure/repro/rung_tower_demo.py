#!/usr/bin/env python3
"""
Rung tower demonstration (Paper I copy of the cascade rung-tower demo).

This script is a mirror of the original cosmic_demo.py from the withheld
Extension IV (Cosmic Self-Pruning and Frame Recurrence). It is bundled
here for Paper I (Existence as Closure) as a self-contained reproducibility
artifact for the cascade-rung-tower facts (C1) used in Paper I §6. No
recurrence or cosmic-pruning claims from Extension IV are used in Paper I;
only the per-rung substrate / closure-operator / sigma-twist construction
demonstrated by C1 below.

Demos (C1-C5; C1 is the one Paper I depends on):

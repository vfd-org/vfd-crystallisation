    # Dedication and Acknowledgements — DRAFT for review

*(Not yet added to the book. Three pieces below: the Dedication page that would sit at the front, the longer Acknowledgements / Author's Note that would sit at the back, and the author details for the About-the-Author page and copyright. Names corrected from your message — please confirm spellings: Ethan, Isabella, Alison; brother Darran; cousin Phil.)*

---

## 1. Dedication (front matter page)

*For my father, who is no longer here to read this, and who gave me the patience the whole of it was built on. He spent himself quietly in the rat race so that there was food on the table, clothes on our backs, and a roof over our heads — always providing, never once asking for anything back. Whatever steadiness is in these pages is his.*
...
## 2. Acknowledgements / A Personal Note (back matter)
...
My mother gave me character, which is a harder and stranger gift. She gave it through illness and through difficulty, by being strong in the exact places where strength is most expensive, and by refusing — quietly, stubbornly — to let me believe that a dream was too tall to be worth reaching for, even when it plainly was. Every long stretch of this project that looked, from the inside, unimaginable, I got through partly on a habit of mind that is hers: the refusal to mistake "very difficult" for "impossible." She is the reason the ladder in these pages always had one more rung worth trying.
...
*(Copyright line would change from "VFD_org" to "Lee Smart / Institute of Vibrational Field Dynamics." Confirm if you'd like your name on the cover and title page, or to keep VFD_org as the public-facing author with Lee Smart credited inside.)*

...
![Figure 3.1. The five Platonic solids — the entire list three dimensions permit. Tetrahedron, cube, octahedron, dodecahedron, icosahedron, drawn here from their real coordinates. There is no sixth, and the absence is forced: the angles around a corner run out of room. This is the cleanest example of a structure that is left over when consistency has finished saying no.](figures/ch03-platonic.png)
...
![Figure 3.2. The 600-cell, the crystal this book turns on, shadowed down from four dimensions onto the page. All hundred and twenty corners and seven hundred and twenty edges are here, projected onto the plane that shows its symmetry most plainly, so the corners fall into clean concentric rings. We cannot see four dimensions directly, but the projection is exact, not an artist's impression.](figures/ch03-600cell.png)
...
E8 is, by a wide margin, the most symmetric structure of its kind that exists in any dimension up through the ones where such things have been fully classified. It is a lattice, an infinitely repeating arrangement of points in eight-dimensional space, and around any one of its points sit two hundred and forty nearest neighbours, arranged with a regularity that is almost hard to believe when you first compute it.

![Figure 3.3. The E8 root system: the two hundred and forty nearest neighbours of a point in the eight-dimensional lattice, projected onto the one plane where its symmetry shows fullest. The eight nested rings of thirty are not decoration; they are what the arrangement actually looks like, computed from the lattice. The 600-cell of Figure 3.2 sits inside this, a four-dimensional shadow of the eight-dimensional parent.](figures/ch03-e8.png) For decades E8 was admired as a kind of mathematical Everest, climbed for the view. What matters for us is a fact that sounds like a coincidence and is not: the 600-cell, our four-dimensional crystal, sits inside E8. The hundred and twenty corners of the crystal can be placed among the two hundred and forty neighbours of E8 in a way that fits, golden ratio and all. The crystal is a shadow of the eight-dimensional pinnacle, and the pinnacle is the crystal's parent. We'll need both before we're done, the 600-cell for the world we can see and E8 for the structure standing behind it.
...
::: {.codebox}
**Behind the maths.** That the hundred-and-twenty-point group is the unique perfect, maximal one, that it *is* the 600-cell, and that its multiplication table alone reproduces the diagram of E8, are set out in full in **Paper LIV, _The Forced Crystal_**, and checked by the `verify_crystal_forcing.py` suite — fourteen tests, each with a deliberate wrong-answer control. To run it yourself, clone the companion repository and run `bash run_all_verifications.sh`; every figure and claim in this book regenerates from it.

...
Physics mostly doesn't ask this, and for a good reason: it has better things to do. It takes a great deal as given and gets on with the work. There is space, it says, with three dimensions. There is time, running one way. Inside them sit particles carrying fixed properties, this much mass and that much charge, obeying laws we're clever enough to write down. The assumptions work so well that poking at them feels almost rude, like stopping a pianist mid-concert to ask who settled on eighty-eight keys.
...
So, a promise, the same one the opening pages made, renewed here because it governs everything that follows. I'll keep both columns in front of you the whole way through. There is the part you can check, the geometry and the calculations that are flatly right or flatly wrong and that you could verify or knock down yourself, which is large and is the reason the book exists. And there is interpretation, the leap from "the geometry produces this structure" to "and that structure is the world you live in," which is real too and which I will never disguise as proof. When we cross from the first column into the second, I'll say so, and mark the exact spot where we've stepped past what's been shown.

The quickest way to lose your trust would be to let the precision of the checkable part lend borrowed authority to the speculative part. That is the signature failure of grand theories, and I'd rather earn your scepticism honestly than your enthusiasm on credit. The real open problems, the things this framework can't yet do, get their own chapter, out in the open, not tucked into a footnote where no one looks. A theory's unsolved problems mark its frontier, and the frontier is the most honest place a person can stand.

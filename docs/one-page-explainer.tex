...
\textbf{Physical states = configurations that satisfy closure.}\\
...
\begin{itemize}[nosep, leftmargin=12pt]
    ...
    \item \textbf{Electroweak} --- projection invariance (torsional symmetry)
...
Colour (3) & threefold shell structure \\

...
The set of events carries a natural strict partial order given by birth-angle comparison. This ordering is proved to be irreflexive, transitive, and non-total. It is not assumed as a background temporal structure; it is derived from the phase-overlap structure of the dual 600-cell geometry. The paper interprets this order as an emergent temporal structure: temporal succession arises from the ordering of admissible configurations rather than from an external clock. A no-canonical-global-clock theorem shows that no unique real-valued total ordering is determined solely by the event structure. A worked example on two pentagons demonstrates the construction explicitly.

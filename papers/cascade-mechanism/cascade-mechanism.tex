...
\cite{CascadeRefinementCompat}~\S1.5; the third lift hypothesis
...
\item In lieu of a worked occurrence, the paper supplies a
  ...
  \cite{CascadeRefinementCompat}~\S1.5.
...
\cite{CascadeRefinementCompat}~\S1.5. A compressed nine-row programme-placement table

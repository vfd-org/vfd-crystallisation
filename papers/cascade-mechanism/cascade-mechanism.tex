...
$\Schur(\widetilde A_{n+1}) = \widetilde A_n$ and partially
discharges (O2) at the boundary-energy / quadratic-form level (the
strict operator-level identity
$p^{0} \widetilde A_{n+1} = \widetilde A_n p^{0}$ remains false,
with explicit defect supported on the new-vertex sector). (O1)
...
intertwining of (O2) for the curvature flow remains the only
substantive open ask in the imported P3/P4 tower at the level of
...
& (O0) closed at the finite-dimensional level; (O3) closed for the scaled curvature $\widetilde A_n = 2^n A_n^{\mathrm{vertex}}$ via the Schur-complement identity $\mathrm{Schur}(\widetilde A_{n+1}) = \widetilde A_n$ \cite{CascadeRefinementCompat}; (O2) partially closed at the boundary-energy / Schur level (strict operator/flow-level identity $p^{0} \widetilde A_{n+1} = \widetilde A_n p^{0}$ remains false, with explicit defect on the new-vertex sector); (O1) reduces to spectral decomposition on the connected graph Laplacian. \\

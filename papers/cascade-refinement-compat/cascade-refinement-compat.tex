...
\item (already-proved input) the parent-fibre averaging map
  ...
  model. This is \cite{CascadeRefinementSpaces}~Proposition
  Proposition~\texttt{prop:adjoints}, parts (3)--(4); we retain the
  label here for downstream reference;
...
Proposition~\texttt{prop:coboundary-refinement}.)

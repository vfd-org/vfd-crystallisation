...
The present paper proposes a candidate resolution: a deterministic selection architecture, termed \textit{crystallisation}, that acts over a restricted admissible subset of the Dirac solution space. The architecture is defined by a schematic constraint functional whose extrema are interpreted as candidate physically realised states. The proposal extends rather than replaces the Dirac framework; it adds a selection layer to the existing mathematical structure without modifying the equation itself.
...
\midrule
Selection architecture & Axiomatic & Stochastic & Constraint-based extremisation \\

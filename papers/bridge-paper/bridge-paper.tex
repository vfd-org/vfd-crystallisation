...
The admissible domain $\mathcal{S}_{\mathrm{adm}} \subset \mathcal{S}$ consists of normalised, finite-energy states satisfying the relevant boundary conditions and symmetry constraints of a concrete physical context. By ``measurement-conditioned'' we mean conditioned by the interaction structure, macroscopic boundary conditions, and symmetry constraints of a concrete experimental arrangement.
\end{definition}
...
Potential empirical signatures & No (interpretive) & Yes (rate) & Coherence measures, convergence timescales \\

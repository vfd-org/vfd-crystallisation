...
The graph Laplacian of the 600-cell vertex adjacency graph has eigenvalue $\lambda = 15$. The closure invariant difference between proton and electron closure classes is $\Delta C = C(\{2,3,4\}) - C(\{1\}) = 14 - (-1) = 15$. Therefore $\Delta C$ is equal to an eigenvalue of the 600-cell Laplacian.
\end{proposition}

...
\item $V_{16} = \Cl(1, 3)$ with the Hilbert--Schmidt-style trace
  ...
  \rangle_0$, where $a^\dagger$ is the principal involution
  (anti-automorphism reversing Clifford generators) of
  \cite[Ch.~9]{Lounesto}, $\langle \cdot \rangle_0$ is the
  scalar-grade projection, and the form is positive-definite by
  \cite[Ch.~9]{Lounesto}, via
...
\cite[Ch.~1]{HumphreysReflectionGroups}; the underlying root
...
\cite{AlgebraicSubstrate}: $V_{D_4} = \R^4$ has

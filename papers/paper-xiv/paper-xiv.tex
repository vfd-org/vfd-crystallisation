...
\begin{enumerate}
    \item \textbf{Stationary distribution:} The process admits a stationary distribution $P_{\mathrm{st}}(\psi) \propto \exp(-2\Fcal(\psi)/\sigma^2)$, unique under standard irreducibility conditions.

...
explicit explicit generator-family list of \emph{admissible finite-level
...
\item No universal ``all correspondences are Borel and
  ...
  Section~\ref{sec:intertwiners} gives a explicit generator-family list
...
$j_{n, n+1}^1$ (edge embedding) & $\|j^1\|_{\op} = 2^{-1/2}$ &
  \cite[Proposition~\texttt{prop:adjoints}]{RefinementSpaces} (rescaled replication:
...
\item No universal Borel/equivariance principle beyond the
  explicit explicit generator-family list.
\end{enumerate}

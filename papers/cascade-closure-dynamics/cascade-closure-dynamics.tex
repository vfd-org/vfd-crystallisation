...
Definition~\ref{def:Xn-1} the $X_n^1$ inner product carries a
factor $\tfrac{1}{2}$ to compensate for the antisymmetric
oriented-edge double count. Compute
\begin{align*}
...
The form $E_n$ here is the off-diagonal coboundary square; this
...
linear map between its finite-dimensional domain and codomain.
Specifically:
\begin{enumerate}

...
print(f"""
  ...
  × R_D(4) = 15 (established as an exact rational theorem in Theorem thm:RD4
    of Paper V via the absorbing Markov chain; see run_rd4_exact_rational.py.
    Earlier versions of this script used a capped value R_D(4) = 10 as an
    interim approximation; that cap is superseded.)
